...
main (int argc, char *argv[])
{
  ...
  ApplicationContainer serverApps_2 = echoServer_2.Install (csmaNodes.Get (nCsma));
  ...
  UdpEchoClientHelper echoClient_2 (csmaInterfaces.GetAddress (nCsma), 12);
  ...
  ApplicationContainer clientApps_2 = echoClient_2.Install (p2pNodes.Get (0));
